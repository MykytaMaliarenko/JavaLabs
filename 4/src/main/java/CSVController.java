...
public class CSVController {
    ...
    private List<CSVParserWorker> workers;
    private CSVParser parser;

    public CSVController() { }

    public CSVController(String inputDelimiter, String outputDelimiter, int numOfWorkers) {
        this.inputDelimiter = inputDelimiter;
        this.outputDelimiter = outputDelimiter;
        this.numOfWorkers = numOfWorkers;

        this.workers = new LinkedList<>();
        this.parser = new CSVParser(inputDelimiter, outputDelimiter);
    }
    ...
    public void parseDirectory(String directoryPath, String outputFilePath) {
        ...
        for (int i = 0; i < numOfWorkers; i++) {
            CSVParserWorker worker = new CSVParserWorker(this.parser, inputQueue, outputQueue);
        ...
        try {
            ...
            for (CSVParserWorker worker: workers)
                inputQueue.put("!");
